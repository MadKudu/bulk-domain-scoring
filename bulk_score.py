        ...
        try:
            ...
            for line in range(start + skip_empty, rows):
                ...
                if score_type == 'domain':
                    ...
                    result.write(
                        "{},{},{}\n".format(
                            domain, customer_fit['segment'], customer_fit['score'], customer_fit['top_signals_formatted'])
                    )
                if score_type == 'email':
                    email = person["email"]
                    ...
                    result.write(
                        "{},{},{},{}\n".format(
                            email, customer_fit['segment'], customer_fit['score'], customer_fit['top_signals_formatted'])
                    )        
        except Exception:
            result.flush()
